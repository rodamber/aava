...
/* package haskell-impl-0.1.0.0 */
#define VERSION_haskell_impl "0.1.0.0"
#define MIN_VERSION_haskell_impl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-impl-0.1.0.0-5QZQUPOQJel4VPmddVin6V"

#define CURRENT_PACKAGE_KEY "haskell-impl-0.1.0.0-5QZQUPOQJel4VPmddVin6V"
